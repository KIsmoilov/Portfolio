...
> This is the first Protfolio project. The main tasks are setting up a repository and creating all pages of the mobile version and responsive desktop version of the project using HTML and CSS.
